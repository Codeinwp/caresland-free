...
function ti_caresland_lite_setup() {
	 ...
	 * to change 'ti-caresland-lite' to the name of your theme in all the template files
	 */
	load_theme_textdomain( 'ti-caresland-lite', get_template_directory() . '/languages' );
	...
	register_nav_menus( array(
		'ti-caresland-lite-primary' => __( 'The Primary Menu', 'ti-caresland-lite' ),
	) );
...
function ti_caresland_lite_widgets_init() {
	register_sidebar( array(
		'name'          => __( 'Sidebar', 'ti-caresland-lite' ),
		'id'            => 'sidebar-1',
	...
	register_sidebar( array(
		'name'          => __( 'Footer1', 'ti-caresland-lite' ),
		'id'            => 'footer-1',
	...
	register_sidebar( array(
		'name'          => __( 'Footer2', 'ti-caresland-lite' ),
		'id'            => 'footer-2',
		'before_widget' => '<div id="%1$s" class="footer-box-inside">',
		'after_widget'  => '</div>',
		'before_title'  => '<h1 class="footer-widget-title">',
	...
	register_sidebar( array(
		'name'          => __( 'Footer3', 'ti-caresland-lite' ),
		'id'            => 'footer-3',
		'before_widget' => '<div id="%1$s" class="footer-box-inside">',
		'after_widget'  => '</div>',
		'before_title'  => '<h1 class="footer-widget-title">',
	...
	register_sidebar( array(
		'name'          => __( 'Footer4', 'ti-caresland-lite' ),
		'id'            => 'footer-4',
		'before_widget' => '<div id="%1$s" class="footer-box-inside">',
		'after_widget'  => '</div>',
		'before_title'  => '<h1 class="footer-widget-title">',
