...
add_filter( 'themeisle_sdk_products', 'careslandfree_load_sdk' );
/**
 ...
 */
function careslandfree_load_sdk( $products ) {
...
function ti_caresland_lite_setup() {
	...
	add_theme_support(
		'custom-background', apply_filters(
			'ti_caresland_lite_custom_background_args', array(
