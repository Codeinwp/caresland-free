...
function ti_caresland_lite_customize_register( $wp_customize ) {
	...
	$wp_customize->add_section(
		'ti_caresland_lite_theme_notes', array(
	...
	/* logo */
	$wp_customize->add_section(
		'ti_caresland_lite_logo_section', array(
	...
	/* Social icons*/
	$wp_customize->add_section(
		'ti_caresland_lite_link_section', array(
	...
	$wp_customize->add_setting(
		'ti_caresland_lite_social_link_fb',
		array(
		'sanitize_callback' => 'ti_caresland_lite_sanitize_text',
		'default'     => '#',
		'transport'   => 'refresh',
		)
	);
	$wp_customize->add_control(
		'ti_caresland_lite_social_link_fb', array(
	...
	$wp_customize->add_setting(
		'ti_caresland_lite_social_link_tw',
		array(
		'sanitize_callback' => 'ti_caresland_lite_sanitize_text',
		'default'     => '#',
		'transport'   => 'refresh',
	...
	$wp_customize->add_control(
		'ti_caresland_lite_social_link_tw', array(
	...
	$wp_customize->add_setting(
		'ti_caresland_lite_social_link_gp',
		array(
		'sanitize_callback' => 'ti_caresland_lite_sanitize_text',
		'default'     => '#',
		'transport'   => 'refresh',
	...
	$wp_customize->add_control(
		'ti_caresland_lite_social_link_gp', array(
	...
	$wp_customize->add_setting(
		'ti_caresland_lite_social_link_in',
		array(
		'sanitize_callback' => 'ti_caresland_lite_sanitize_text',
		'default'     => '#',
		'transport'   => 'refresh',
	...
	$wp_customize->add_control(
		'ti_caresland_lite_social_link_in', array(
	...
	$wp_customize->add_setting(
		'ti_caresland_lite_social_link_yo',
		array(
		'sanitize_callback' => 'ti_caresland_lite_sanitize_text',
		'default'     => '#',
		'transport'   => 'refresh',
	...
	$wp_customize->add_control(
		'ti_caresland_lite_social_link_yo', array(
	...
	/* Footer contact info*/
	$wp_customize->add_section(
		'ti_caresland_lite_footer_info_section', array(
	...
	$wp_customize->add_setting(
		'ti_caresland_lite_footer_info_email',
		array( 'sanitize_callback' => 'ti_caresland_lite_sanitize_text' )
	);
	$wp_customize->add_control(
		'ti_caresland_lite_footer_info_email', array(
	...
	$wp_customize->add_setting(
		'ti_caresland_lite_info_support',
		array( 'sanitize_callback' => 'ti_caresland_lite_sanitize_text' )
	);
	$wp_customize->add_control(
		'ti_caresland_lite_info_support', array(
	...
	$wp_customize->add_setting(
		'ti_caresland_lite_footer_info_chat',
		array( 'sanitize_callback' => 'ti_caresland_lite_sanitize_text' )
	);
	$wp_customize->add_control(
		'ti_caresland_lite_footer_info_chat', array(
